...
*LOW typically means the transaction is safe to auto-approve.
...
CRITICAL means the transaction is almost certainly malicious or violating fundamental rules, leading to automatic rejection.*
