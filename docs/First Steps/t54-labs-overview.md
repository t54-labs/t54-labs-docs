...
|                  |   Claire Card (Planned)   | [Physical payment device](https://www.notion.so/Ezy-Hardware-Payment-Device-Product-Requirements-Document-249a7de921c380eab5e9fe9792d793c9?source=copy_link) enabling real-world transactions paired with financial agents |                                          |
